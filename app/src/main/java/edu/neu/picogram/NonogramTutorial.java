...
public class NonogramTutorial {
  ...
  public NonogramTutorial(int id, String description, Boolean isGame, int imageId) {
    this.id = id;
  ...
  public NonogramTutorial(
      ...
      int[][] solution,
      int[][] currentGrid) {
    this(id, description, isGame, width, height, rowClues, colClues, solution);
